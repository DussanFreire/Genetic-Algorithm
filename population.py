...
class Population:
    ...
    def find_the_most_powerful_chr(self, number_of_experiment):
        max_ffs, min_ffs, ff_means, solutions = GenerationFactory.search_the_most_powerful_ff(self.chromosomes, self.setting)
        generation_report = Report(max_ffs, min_ffs, ff_means, number_of_experiment, solutions, self.setting)
...
# p_10.setting.set_fitness_function("queens in peace")
# p_10.setting.NUMBER_OF_EXPERIMENTS = 1
# reports_10 = p_10.run_experiment()
# reports_10[0].display_solutions()
